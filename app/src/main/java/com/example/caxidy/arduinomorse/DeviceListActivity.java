...
/*!!Que envie (los caracteres de )un mensaje por Android y lo reciba el bluetooth de Arduino.
* Lo que recibe el Bluetooth, segun el caracter, se transforma en un codigo morse, que el buzzer emite.*/
